...
@st.cache_data
def Bug_random_positions_4(num_points=100):
    positions = []
...
random_positions_Bug_4 = Bug_random_positions_4()
...
keyframes_Bug = keyframes_CSS_Bug(random_positions_Bug_4)
...
@st.cache_data
def Escargot_random_positions_4(num_points=100):
    positions = []
    for _ in range(num_points):
        top = random.randint(12, 95)  # Random top position (12% to 95%)
        left = random.randint(5, 95)  # Random left position (5% to 95%)
...
random_positions_Escargot_4 = Escargot_random_positions_4()
...
keyframes_Escargot = keyframes_CSS_Escargot(random_positions_Escargot_4)
